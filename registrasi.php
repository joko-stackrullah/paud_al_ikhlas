...
<body class="bg-gradient-primary">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="p-5">
                  ...
                  <form name="form_registrasi" class="user" action="registrasi_control.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                    ...
                    <button type="submit" name="btn_registrasi" value="simpan" class="btn btn-primary btn-user btn-block" >
                      Registrasi
                    </button>
                  </form>
                  <hr>
  ...
  <script type="text/javascript">
    $(function(){
      ...
      var yyyy = tdate.getFullYear()-3; //yields year
      var currentDate= dd + "-" + (MM<10?('0'+MM):MM) + "-" + yyyy;
      $(".datepicker").datepicker("setDate",currentDate)
    });

    function validateForm() {
      let x = document.forms["form_registrasi"];
      if (x["nama"].value == "") {
        alert("Nama Tidak Boleh Kosong !");
        return false;
      }else if(x["tempat_lahir"].value == ""){
        alert("Tempat Lahir Tidak Boleh Kosong !");
        return false;
      }else if(x["tanggal_lahir"].value == ""){
        alert("Tanggal Lahir Tidak Boleh Kosong !");
        return false;
      }else if(x["jenis_kelamin"].value == ""){
        alert("Jenis Kelamin Tidak Boleh Kosong !");
        return false;
      }else if(x["agama"].value == ""){
        alert("Agama Tidak Boleh Kosong !");
        return false;
      }else if(x["alamat"].value == ""){
        alert("Alamat Tidak Boleh Kosong !");
        return false;
      }else if(x["file"].value == ""){
        alert("Harap Upload Bukti Pembayaran !");
        return false;
      }else if(x["email"].value == ""){
        alert("Email Tidak Boleh Kosong !");
        return false;
      }else if(x["telepon"].value == ""){
        alert("Telepon Tidak Boleh Kosong !");
        return false;
      }else if(x["password"].value == "" || x["ulangi_password"].value == ""){
        alert("Password Tidak Boleh Kosong !");
        return false;
      }else if(x["password"].value !== x["ulangi_password"].value){
        alert("Password Tidak sama,Mohon Cek Kembali !");
        return false;
      }
    }
  </script>
