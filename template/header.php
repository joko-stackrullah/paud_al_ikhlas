...
<head>
  ...
  <meta name="description" content="Aplikasi pendaftaran PAUD Al-Ikhlas Pondok Pucung .">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <?php if($_SESSION['level'] == 'siswa') { ?>
          ...
          <li class="nav-item">
            <a class="nav-link" href="kegiatan_siswa.php">
              <i class="fas fa-fw fa-list"></i>
              <span>Kegiatan Siswa</span></a>
          </li>
      ...
      <?php if($_SESSION['level'] == 'admin') { ?>
          ...
          <li class="nav-item">
            <a class="nav-link" href="wali.php">
              <i class="fas fa-fw fas fa-chalkboard-teacher"></i>
